				...
				<td>
					...
					<table class="row row-2" align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
						<tbody>
							<tr>
								<td>
									<table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #0e0eb3; background-image: url('https://d1oco4z2z1fhwp.cloudfront.net/templates/default/2016/background.png'); background-position: top center; background-repeat: no-repeat; color: #000000; width: 600px; margin: 0 auto;" width="600">
										<tbody>
											<tr>
														...
														<tr>
															<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
																<div class="alignment" align="right" style="line-height:10px">
																	<div style="max-width: 210px;"><img src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/2016/ONMTS-1_1.png" style="display: block; height: auto; border: 0; width: 100%;" width="210" alt="Ornament" title="Ornament" height="auto"></div>
																</div>
															</td>
														</tr>
													</table>
...
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{url}}" style="height:42px;width:125px;v-text-anchor:middle;" arcsize="96%" stroke="false" fillcolor="#851fe5">
<w:anchorlock/>
														...
														<tr>
															<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
																<div class="alignment" align="left" style="line-height:10px">
																	<div style="max-width: 330px;"><img src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/2016/ONMTS-2_1.png" style="display: block; height: auto; border: 0; width: 100%;" width="330" alt="Ornament" title="Ornament" height="auto"></div>
																</div>
															</td>
														</tr>
													</table>
