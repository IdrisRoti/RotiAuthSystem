														...
														<tr>
															<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
																<div class="alignment" align="right" style="line-height:10px">
																	<div style="max-width: 330px;"><img src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/2016/ONMTS-1_1.png" style="display: block; height: auto; border: 0; width: 100%;" width="330" alt="Ornament" title="Ornament" height="auto"></div>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad" style="padding-bottom:5px;padding-left:30px;padding-right:30px;padding-top:5px;">
																<div style="color:#dcdcdc;font-family:Cabin, Arial, Helvetica Neue, Helvetica, sans-serif;font-size:16px;line-height:180%;text-align:center;mso-line-height-alt:28.8px;">
																	<p style="margin: 0; word-break: break-word;"><span>Please click on the button below to verify your account.</span></p>
																</div>
															</td>
														</tr>
													</table>
...
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{url}}" style="height:42px;width:189px;v-text-anchor:middle;" arcsize="96%" stroke="false" fillcolor="#851fe5">
<w:anchorlock/>
